...
<div class="modal-dialog">
    	<div class="modal-content">
      	...
      	<div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Import Data Kecamatan</h4>
        </div>
		...
		<form name="myForm" id="myForm" onSubmit="return validateForm()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
         ...
         <div class="modal-footer">
			...
			//             kosongkan tabel sektor usaha
						 $truncate ="TRUNCATE TABLE kecamatan";
			...
			//      setelah data dibaca, masukkan ke tabel pegawai sql
				  $query = "INSERT into kecamatan (kode_kecamatan, nama_kecamatan)values('$idkec','$namkec')";
