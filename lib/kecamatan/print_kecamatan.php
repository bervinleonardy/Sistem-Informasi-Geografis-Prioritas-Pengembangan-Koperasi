...
$excelku->getActiveSheet()->getColumnDimension('E')->setWidth(75);
...
$SI->setCellValue('C4', 'Data Kecamatan'); //Judul laporan
...
$SI->setCellValue('D6', 'Nama Kecamatan'); //Kolom jenis
...
$excelku->getActiveSheet()->setSharedStyle($headerStylenya, "C6:E6");
...
while ($row = mysqli_fetch_array($query)) {	
  ...
  $SI->setCellValue("D".$baris,$row['nama_kecamatan']); //mengisi data untuk jenis
  $no++;
  $baris++; //looping untuk barisnya
}
//Membuat garis di body tabel (isi data)
$excelku->getActiveSheet()->setSharedStyle($bodyStylenya, "C7:E$baris");


//Memberi nama sheet
$excelku->getActiveSheet()->setTitle('Kecamatan');

$excelku->setActiveSheetIndex(0);

// untuk excel 2007 atau yang berekstensi .xlsx
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename=data-kecamatan.xlsx');
