...
<div class="modal-dialog">
    	<div class="modal-content">
      	...
      	<div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Import Data Sektor Usaha</h4>
        </div>
		...
		<form name="myForm" id="myForm" onSubmit="return validateForm()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
         ...
         <div class="modal-footer">
			...
			//             kosongkan tabel sektor usaha
						 $truncate ="TRUNCATE TABLE sektor_usaha";
			...
			//      setelah data dibaca, masukkan ke tabel pegawai sql
				  $query = "INSERT into sektor_usaha (id_sektor, nama_sektor)values('$idsek','$namsek')";
