...
<div class="table-agile-info">        
  <div class="panel panel-default">  
	...
	<?php
		include'lib/kecamatan/list_kecamatan.php';
	?>
     	</div>
	</div>
  </div>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ModalAdd" class="modal fade">
	<div class="modal-dialog">
        ...
        <div class="modal-body">
          <form action="lib/kecamatan/add_kecamatan.php" name="modal_popup" enctype="multipart/form-data" method="POST">     
			  
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Name">Kode Kecamatan</label>
  					<input type="text" name="kdkecamatan"  class="form-control" placeholder="Kode Kecamatan" required>
                </div>   
			  
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Name">Nama Kecamatan</label>
                  <input type="text" name="namakec"  class="form-control" placeholder="Nama Kecamatan" required>
                </div>
...
<script type="text/javascript">
   ...
   $(".open_modal").click(function(e) {
      var m = $(this).attr("id");
		   $.ajax({
    			   url: "lib/kecamatan/edit_kecamatan.php",
    			   type: "GET",
    			   data : {edit: m,},
    			   success: function (ajaxData){
